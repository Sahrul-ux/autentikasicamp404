...
<body>
    <br>
    <p style="text-align: center; text-transform: uppercase;">Login</p>
    <center>
        <?php
        if (isset($_GET['pesen'])) {
            if ($_GET['pesan'] == "gagal") {
    ...
    <form method="post">
        <table align="center">
            ...
            <tr>
                <td>Password</td>
                <td>:</td>
                <td><input type="text" class="form_login" name="password" required="required"></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
        ...
        <center>
            ...
            <p>Jika belum silahkan lakukan <a href="register.php">register</a></p>
        </center>
